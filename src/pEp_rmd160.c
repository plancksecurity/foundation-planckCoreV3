/**
 * @file    pEp_rmd160.h
 * @brief   RMD160 implementation, taken from libTomCrypt with relatively
 *          minor changes to avoid adding a dependencies or copying too
 *          many source files
 * @license GNU General Public License 3.0 - see LICENSE.txt
 */

/* LibTomCrypt, modular cryptographic library -- Tom St Denis
   Adapted by Luca Saiu in 2022 for inclusion in the pEp Engine. */

/* SPDX-License-Identifier: Unlicense */
//#include "tomcrypt_private.h"  // removed for pEp

/**
   // pEp: This used to be src/hashes/rmd160.c in libTomCrypt
   RMD160 hash function
*/

/* Simplifications for pEp
 * ***************************************************************** */
...
#define CRYPT_HASH_OVERFLOW -1
#if ! defined(NULL)
#   define NULL 0
#endif
#define XMEMCPY memcpy

struct rmd160_fields {
    ulong64 length;
...
typedef struct _hash_state {
  struct rmd160_fields rmd160;
} hash_state;

#define LTC_ARGCHK(whatever)  do { /* Do nothing. */ } while (0)

// Copied from tomcrypt_private.h:
...
/* The pEp convenience wrapper declared in rmd160.h
 * ***************************************************************** */
...
void pEp_rmd160(unsigned char *out, const unsigned char *in, size_t in_byte_no)
{
    ...
    hash_state md;
    rmd160_init(& md);
    rmd160_process(& md, in, in_byte_no);
    rmd160_done(& md, out);
}
