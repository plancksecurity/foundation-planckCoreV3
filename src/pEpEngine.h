...
// 18.10.2023/TC - added identities out param, additionally made the param names more descriptive
/**
 ...
 *  @param[out]    identities             list of identities containing the
 *                                        keys that have been imported
 *  @param[out]    private_ident          list of identities containing the
