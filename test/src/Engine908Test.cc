...
TEST_F(Engine908Test, check_engine908_with_910_true) {
...
TEST_F(Engine908Test, check_engine908_with_default_set_with_910_true) {
    config_key_election_disabled(session, true);
...
TEST_F(Engine908Test, check_engine908_with_key_reset_with_910_true) {
    config_key_election_disabled(session, true);
