...
EnterLeaveDeviceGroupTests::EnterLeaveDeviceGroupTests(string suitename, string test_home_dir) :
    ...
    add_test_to_suite(std::pair<std::string, void (Test::Suite::*)()>(string("EnterLeaveDeviceGroupTests::check_leave_device_group_empty"),
                                                                      static_cast<Func>(&EnterLeaveDeviceGroupTests::check_leave_device_group_empty)));
    add_test_to_suite(std::pair<std::string, void (Test::Suite::*)()>(string("EnterLeaveDeviceGroupTests::check_leave_device_group_sole"),
                                                                      static_cast<Func>(&EnterLeaveDeviceGroupTests::check_leave_device_group_sole)));
    add_test_to_suite(std::pair<std::string, void (Test::Suite::*)()>(string("EnterLeaveDeviceGroupTests::check_leave_device_group_one_in_one_out"),
                                                                      static_cast<Func>(&EnterLeaveDeviceGroupTests::check_leave_device_group_one_in_one_out)));
    add_test_to_suite(std::pair<std::string, void (Test::Suite::*)()>(string("EnterLeaveDeviceGroupTests::check_leave_device_group_three_in"),
                                                                      static_cast<Func>(&EnterLeaveDeviceGroupTests::check_leave_device_group_three_in)));
    add_test_to_suite(std::pair<std::string, void (Test::Suite::*)()>(string("EnterLeaveDeviceGroupTests::check_leave_device_group_two_in_one_out"),
                                                                      static_cast<Func>(&EnterLeaveDeviceGroupTests::check_leave_device_group_two_in_one_out)));
}
...
void EnterLeaveDeviceGroupTests::check_leave_device_group_empty() {
    PEP_STATUS status = leave_device_group(session);
    TEST_ASSERT_MSG(status == PEP_STATUS_OK, tl_status_string(status));
}

void EnterLeaveDeviceGroupTests::check_leave_device_group_sole()  {
    pEp_identity* alice_id = NULL;
    TEST_ASSERT(slurp_and_import_key(session, "test_keys/pub/pep-test-alice-0x6FF00E97_pub.asc"));    
    PEP_STATUS status = set_up_ident_from_scratch(session,
                                "test_keys/priv/pep-test-alice-0x6FF00E97_priv.asc",
...
void EnterLeaveDeviceGroupTests::check_leave_device_group_one_in_one_out()  {
    pEp_identity* alice_id = NULL;
    TEST_ASSERT(slurp_and_import_key(session, "test_keys/pub/pep-test-alice-0x6FF00E97_pub.asc"));    
    PEP_STATUS status = set_up_ident_from_scratch(session,
                                "test_keys/priv/pep-test-alice-0x6FF00E97_priv.asc",
...
void EnterLeaveDeviceGroupTests::check_leave_device_group_three_in()  {
    pEp_identity* alice_id = NULL;
    TEST_ASSERT(slurp_and_import_key(session, "test_keys/pub/pep-test-alice-0x6FF00E97_pub.asc"));    
    PEP_STATUS status = set_up_ident_from_scratch(session,
                                "test_keys/priv/pep-test-alice-0x6FF00E97_priv.asc",
...
void EnterLeaveDeviceGroupTests::check_leave_device_group_two_in_one_out()  {
    pEp_identity* alice_id = NULL;
    TEST_ASSERT(slurp_and_import_key(session, "test_keys/pub/pep-test-alice-0x6FF00E97_pub.asc"));    
    PEP_STATUS status = set_up_ident_from_scratch(session,
                                "test_keys/priv/pep-test-alice-0x6FF00E97_priv.asc",
